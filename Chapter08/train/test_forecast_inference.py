...
latest_version_number = client.get_latest_versions(name="prophet-retail-forecaster")[
    0
].version
model_production_uri = client.get_model_version_download_uri(
    name=model_name, version=latest_version_number
)
...
model_production = mlflow.pyfunc.load_model(
    "/Users/apmcm/dev/Machine-Learning-Engineering-with-Python-Second-Edition/Chapter07/register/artifacts/0/b0747ee336464e7085f95e590db770fd/artifacts/prophet-model"
)
...
for store_id in ["3", "4", "10"]:
    ...
    forecast_index = create_forecast_index(
        begin_date="2023-03-01T00:00:00Z", end_date="2023-03-07T00:00:00Z"
    )
